...
const salaries = [
  ...
  { role: "Account Executive", seniority: "Junior", salary: "65114.17" },
  { role: "Account Executive", seniority: "Intermediate", salary: "86818.89" },
  { role: "Account Executive", seniority: "Senior", salary: "108523.62" },
...
export default function PayCalculator() {
  ...
  const calculate = () => {
    ...
    if (salaryEntry) {
      ...
      setSalaryUSD(Math.trunc(salaryInEUR * 1.151823).toLocaleString())
    }
  }
