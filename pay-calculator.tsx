...
const salaries = [
  ...
  { role: "Account Executive", seniority: "Junior", salary: "66006.54" },
  { role: "Account Executive", seniority: "Intermediate", salary: "88008.72" },
  { role: "Account Executive", seniority: "Senior", salary: "110010.90" },
...
export default function PayCalculator() {
  ...
  const calculate = () => {
    ...
    if (salaryEntry) {
      ...
      setSalaryUSD(Math.trunc(salaryInEUR * 1.136251).toLocaleString())
    }
  }
