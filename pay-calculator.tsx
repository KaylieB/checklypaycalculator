...
const salaries = [
  ...
  { role: "Account Executive", seniority: "Junior", salary: "69786.53" },
  { role: "Account Executive", seniority: "Intermediate", salary: "93048.70" },
  { role: "Account Executive", seniority: "Senior", salary: "116310.88" },
...
export default function PayCalculator() {
  ...
  const calculate = () => {
    ...
    if (salaryEntry) {
      ...
      setSalaryUSD(Math.trunc(salaryInEUR * 1.074706).toLocaleString())
      setMessage("")
    } else {
      setSalaryEUR("N/A")
      setSalaryUSD("N/A")
